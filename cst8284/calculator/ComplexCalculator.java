...
public class ComplexCalculator {
  ...
  public Complex plus(Complex c1, Complex c2) {
    ...
    c = new Complex(real, imag); // save the result to this class's Complex
                                 // number
    return (c);
  }
...
// double realNumerator = c1.getReal() * c2.getReal() + c1.getImag() *
// c2.getImag();
// double imagNumerator = c2.getReal() * c1.getImag() - c1.getReal() *
// c2.getImag();
...
// marks--and add a new divide() method here that employs the complex conjugate
// in the
